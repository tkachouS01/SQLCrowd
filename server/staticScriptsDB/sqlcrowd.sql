...
--
-- Name: sqlcrowd; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE sqlcrowd WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'Russian_Russia.1251';
...
--
-- Name: solution_comments; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: solution_comments_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- Name: solution_comments_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: solution_likes_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- Name: solution_likes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: solution_comments id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: solution_likes id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Data for Name: solution_comments; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Name: solution_comments_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: solution_likes_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: solution_comments solution_comments_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: solution_comments solution_comments_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: solution_likes solution_likes_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: solutions solutions_taskId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: solutions solutions_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: tasks tasks_databaseId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
